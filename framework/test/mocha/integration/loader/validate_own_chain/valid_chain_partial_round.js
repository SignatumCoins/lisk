...
describe('validateOwnChain', async () => {
	...
	localCommon.beforeBlock(
		'lisk_functional_validate_own_chain_valid_chain_partial_round',
		lib => {
			library = lib;
	...
	describe('forge 150 blocks with version = 0', async () => {
		before(() => {
		...
		describe('increase block version = 1 and exceptions for height = 150', async () => {
